Roi's Arabic OnScreen Keyboard
...
מיועד לאנשים שרוצים מקלדת בערבית במחשב אבל לא רוצים שפה שלמה בין המקלדו

למי שרוצה, ניתן לכתוב את האות **באנגלית**  ששווה למקלדת בערבית (G = ل). כמו המקלדת שבגוגל טרנסלייט. אפשר לראות את האות ששווה למקלדת בערבית בזה שהאות השווה כתובה בירוק על האות בערבית. 

נבנה על ידי קלוד, אני לא מתכנת.
